          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border:
                  isRecentlyUpdated
                      ? Border.all(
                        color: (priceChange == PriceChange.increase
                                ? Colors.green
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      return AnimatedContainer(
                        ...
                        height:
                            isRecentlyUpdated ? 45 : 40, // Taller when updated
                        decoration: BoxDecoration(
                          color: indicatorColor,
                          borderRadius: BorderRadius.circular(
                            isRecentlyUpdated ? 3 : 2,
                          ),
                          boxShadow:
                              isRecentlyUpdated
                                  ? [
                            ...
                            StreamBuilder<List<Song>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                if (snapshot.hasData) {
                                  ...
                                  if (updatedSong.currentPrice !=
                                          song.currentPrice &&
                                      !_recentlyUpdatedItems.containsKey(
                                        item.songId,
                                      )) {
                                                    ...
                                                    ? [
                                                      Shadow(
                                                        color: indicatorColor
                                                            .withAlpha(
                                                              128,
                                                            ), // 0.5 opacity equals 128 in alpha (255*0.5)
                                                        blurRadius: 4,
                                                      ),
                                                    ]
                                                    : null,
                        ...
                        StreamBuilder<List<Song>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (snapshot.hasData) {
                              ...
                              updatedValue =
                                  item.quantity * updatedSong.currentPrice;
                            }
